...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('logo/neptune2-favicon.png') }}" />
        ...
        <div id="nav">
            ...
            <div id="nav-fixed">
                <div class="container">
                    <!-- logo -->
                    <div class="nav-logo">
                        <a href="index.html" class="logo"><img src="{{ asset('logo/neptune2-favicon.png') }}" alt=""></a>
                    </div>
                    <!-- /logo -->
            ...
            <div id="nav-aside">
                ...
                <div class="section-row">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="blog-post.html"><img src="{{ asset('front-end/./img/widget-2.jpg') }}"
                                alt=""></a>
                        <div class="post-body">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="blog-post.html"><img src="{{ asset('front-end/./img/widget-3.jpg') }}"
                                alt=""></a>
                        <div class="post-body">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="blog-post.html"><img src="{{ asset('front-end/./img/widget-4.jpg') }}"
                                alt=""></a>
                        <div class="post-body">
                ...
                <div class="col-md-5">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="index.html" class="logo"><img src="{{ asset('front-end/./img/logo.png') }}"
                                    alt=""></a>
                        </div>
                        <ul class="footer-nav">
