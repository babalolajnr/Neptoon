            ...
            <a href="{{ route('home') }}" class="nav-link active">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('addPost') }}" class="nav-link {{ Request::is('posts/create') ? 'active' : ''  }}">
                                        <i class="far fa-book nav-icon"></i>
                                        <p>Add New Post</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('blogHome') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Posts</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('allPosts') }}" class="nav-link {{ Request::is('posts/allPosts') ? 'active' : ''  }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All Posts</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('addCategory') }}" class="nav-link {{ Request::is('categories/create') ? 'active' : ''  }}">
