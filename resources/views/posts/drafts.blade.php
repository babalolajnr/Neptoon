      ...
      <table id="drafts" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                   <a href="{{ url('posts/edit/' .$post->id) }}"><button type="button" class="btn btn-sm btn-outline-warning pr-2">Edit</button> 
                ...
                <span>
                    <form action="/posts/publish/{{ $post->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
